export const CLASE_POR_ESTATUS = {
...
// insignias (no el fondo pastel) — como relleno de barra, el pastel se pierde contra
// --bg-muted.
export const RELLENO_POR_ESTATUS = {
  "POR HACER": "monitor-bar-fill-por-hacer",
