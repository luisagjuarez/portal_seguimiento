-- DROP USER DOVELA_CONTROL;

CREATE USER DOVELA_CONTROL
-- IDENTIFIED BY <password>
;

CREATE TABLE "DOVELA_CONTROL"."02_productBackLog" 
   (	"ID" VARCHAR2(4000), 
	"FECHA_REGISTRO" TIMESTAMP (6), 
	"CLIENTE" VARCHAR2(4000), 
	"MODULO_SISTEMA" VARCHAR2(4000), 
	"REQUERIMIENTO" VARCHAR2(4000), 
	"DESCRIPCION" VARCHAR2(4000), 
	"DETALLES_TECNICOS" VARCHAR2(4000), 
	"PRIORIDAD" VARCHAR2(4000), 
	"ESTIMACION_HRS" VARCHAR2(4000), 
	"HORAS_RESTANTES" VARCHAR2(4000), 
	"TAREAS_CANT" NUMBER, 
	"TAREAS_TERMINADAS" NUMBER, 
	"TAREAS_POR_TERMINAR" NUMBER, 
	"RECURSO_ASIGNADO" VARCHAR2(4000), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "APEX_57219180695447925" ;
;

CREATE TABLE "DOVELA_CONTROL"."CLIENTES" 
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_57219180695447925"  ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
CREATE TABLE "DOVELA_CONTROL"."COMPLEJIDADES" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"COMPLEJIDAD" VARCHAR2(50 CHAR), 
	 CONSTRAINT "COMPLEJIDADES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_BBALL" 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_BBALL" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_BBALL" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_BBALL_1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_BBALL" ("WINS") 
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_DEPT" 
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP" 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP" ADD FOREIGN KEY ("MGR")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP" ("EMPNO") ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP_2" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP" ("DEPTNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP_1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_EMP" ("MGR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_GRADES" 
   (	"ID" NUMBER, 
	"COURSE" VARCHAR2(10), 
	"SCHOOLA" NUMBER, 
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_ORDERS" 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_ORDERS" ADD CONSTRAINT "EBA_DEMO_CHART_ORDER_FK" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_CHART_PRODUCTS" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_ORDERS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_ORDERS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_ORD_2" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_ORDERS" ("PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_ORD_1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_ORDERS" ("QUANTITY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_POPULATION" 
   (	"ID" NUMBER NOT NULL ENABLE, 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_POP" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_POP" ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_PRODUCTS" 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_PRODUCTS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_PRODUCTS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_PROD_1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_PRODUCTS" ("LIST_PRICE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_PROJECTS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_PROJ" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_PROJ" ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLES" 
   (	"SAMPLE1" NUMBER, 
	"SAMPLE2" NUMBER, 
	"SAMPLE3" NUMBER, 
	"SAMPLE4" NUMBER, 
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_DATA" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"SAMPLE_ID" NUMBER, 
	"RESPONSE" NUMBER, 
	"CREATED" TIMESTAMP (6) WITH TIME ZONE, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_DATA" ADD CONSTRAINT "EBA_DEMO_SAMPLE_FK" FOREIGN KEY ("SAMPLE_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_NAMES" ("ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_SAMPLE_DATA" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_SAMPLE_DATA" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_IDX1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_DATA" ("SAMPLE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_SAMPLE_NAMES" 
   (	"ID" NUMBER NOT NULL ENABLE, 
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"NAME" VARCHAR2(2), 
	"COUNTRY" VARCHAR2(30), 
	"EMPLOYEE" NUMBER, 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_STATS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_STATS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS_1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS" ("EMPLOYEE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS_2" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS" ("EMPLOYER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS_3" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_STATS" ("TOTAL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_STOCKS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"ROW_VERSION_NUMBER" NUMBER, 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_STOCKS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_STOCKS" ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_TASKS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT" NUMBER, 
	"PARENT_TASK" NUMBER, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_CHART_TASKS" ADD CONSTRAINT "EBA_DEMO_CHART_TASKS_FK" FOREIGN KEY ("PROJECT")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_CHART_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_TASKS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_CHART_TASKS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_CHART_TASKS_IDX1" ON "DOVELA_CONTROL"."EBA_DEMO_CHART_TASKS" ("PROJECT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_COMMENTS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_COMMENTS" ADD CONSTRAINT "EBA_DEMO_MD_COMMENT_MD_FK" FOREIGN KEY ("PROJECT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_COMMENTS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_COMMENTS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_COMMENT_MD_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_COMMENTS" ("PROJECT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_MILESTONES" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT_ID" NUMBER NOT NULL ENABLE, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_MILESTONES" ADD CONSTRAINT "EBA_DEMO_MD_MSTONE_MD_FK" FOREIGN KEY ("PROJECT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_MILESTONES" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_MILESTONES" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_MSTONE_PRJ_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_MILESTONES" ("PROJECT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT_LEAD" NUMBER, 
	"NAME" VARCHAR2(255) NOT NULL ENABLE, 
	"DESCRIPTION" VARCHAR2(4000), 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ADD CONSTRAINT "EBA_DEMO_MD_TEAM_MEMBER_FK" FOREIGN KEY ("PROJECT_LEAD")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_TEAM_MEMBERS" ("ID") ON DELETE SET NULL ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ADD CONSTRAINT "EBA_DEMO_MD_STATUS_FK" FOREIGN KEY ("STATUS_CD")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_STATUS" ("CD") ON DELETE SET NULL ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_PROJECTS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_PROJECTS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_STATUS_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("STATUS_CD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECT_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("PROJECT_LEAD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_STATUS" 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_STATUS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_STATUS" ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT_ID" NUMBER NOT NULL ENABLE, 
	"MILESTONE_ID" NUMBER, 
	"ASSIGNEE" NUMBER, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_PROJECT_FK" FOREIGN KEY ("PROJECT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_MSTONE_FK" FOREIGN KEY ("MILESTONE_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_MILESTONES" ("ID") ON DELETE SET NULL ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_TEAM_MEM_FK" FOREIGN KEY ("ASSIGNEE")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_TEAM_MEMBERS" ("ID") ON DELETE SET NULL ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASKS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASKS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_MSTONE_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ("MILESTONE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_PROJECT_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ("PROJECT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TEAM_MM_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ("ASSIGNEE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_LINKS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT_ID" NUMBER NOT NULL ENABLE, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_LINKS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_LINK_PRJ_FK" FOREIGN KEY ("PROJECT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_LINKS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_LINK_TSK_FK" FOREIGN KEY ("TASK_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ("ID") ON DELETE CASCADE ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASK_LINKS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASK_LINKS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TSK_LINK_TSK_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_LINKS" ("TASK_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TSK_LINK_PRJ_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_LINKS" ("PROJECT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"PROJECT_ID" NUMBER NOT NULL ENABLE, 
	"TASK_ID" NUMBER NOT NULL ENABLE, 
	"ASSIGNEE" NUMBER, 
...
ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_TODO_PRJ_FK" FOREIGN KEY ("PROJECT_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_PROJECTS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_TODO_TSK_FK" FOREIGN KEY ("TASK_ID")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_TASKS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ADD CONSTRAINT "EBA_DEMO_MD_TASK_TODO_TM_FK" FOREIGN KEY ("ASSIGNEE")
	  REFERENCES "DOVELA_CONTROL"."EBA_DEMO_MD_TEAM_MEMBERS" ("ID") ON DELETE SET NULL ENABLE;

CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASK_TODOS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TASK_TODOS" ENABLE;

CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODO_TM_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ("ASSIGNEE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TSK_TODO_TSK_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ("TASK_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE INDEX "DOVELA_CONTROL"."EBA_DEMO_MD_TSK_TODO_PRJ_IDX" ON "DOVELA_CONTROL"."EBA_DEMO_MD_TASK_TODOS" ("PROJECT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."EBA_DEMO_MD_TEAM_MEMBERS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
...
CREATE OR REPLACE EDITIONABLE TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TEAM_MEMBERS" 
...
/
ALTER TRIGGER "DOVELA_CONTROL"."BIU_EBA_DEMO_MD_TEAM_MEMBERS" ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."ESTADO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
CREATE TABLE "DOVELA_CONTROL"."MODULO_SISTEMA" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(100 CHAR), 
	"DESCRIPCION" VARCHAR2(4000 CHAR), 
	 CONSTRAINT "MODULO_SISTEMA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."PRIORIDADES" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"PRIORIDAD" VARCHAR2(50 CHAR), 
...
CREATE TABLE "DOVELA_CONTROL"."PRODUCT_BACK_LOG" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"PRODUCTO" VARCHAR2(200 CHAR), 
	"DESCRIPCION" VARCHAR2(4000 CHAR), 
	"TIPO" VARCHAR2(50 CHAR), 
	"CLIENTE" VARCHAR2(100 CHAR), 
	"MODULO_SISTEMA" VARCHAR2(100 CHAR), 
	"DETALLE_TECNICO" VARCHAR2(4000 CHAR), 
	"FECHA_REGISTRO" TIMESTAMP (6), 
	"ESTADO" VARCHAR2(100 CHAR), 
	"RECURSO_RESPONSABLE" VARCHAR2(200 CHAR), 
	"ESTIMACION_HORAS" NUMBER, 
	"HORAS_TRABAJADAS" NUMBER, 
	"HORAS_RESTANTES" NUMBER, 
	"TAREAS_CANTIDAD" NUMBER, 
	"TAREAS_TERMINADAS" NUMBER, 
	"TAREAS_RESTANTES" NUMBER, 
	"FECHA_ENTREGA" TIMESTAMP (6), 
	"SOLICITANTE" VARCHAR2(200 CHAR), 
	"FECHA_ACTUALIZACION" TIMESTAMP (6), 
	"ORDEN_PRIORIDAD" NUMBER, 
	 CONSTRAINT "PRODUCT_BACK_LOG_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "DOVELA_CONTROL"."RECURSOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(200 CHAR), 
	"CORREO" VARCHAR2(200 CHAR), 
	"AREA" VARCHAR2(200 CHAR), 
...
CREATE TABLE "DOVELA_CONTROL"."REQUERIMIENTOS" 
   (	"ID" VARCHAR2(4000), 
	"FECHA_REGISTRO" TIMESTAMP (6), 
	"CLIENTE" VARCHAR2(4000), 
	"MODULO_SISTEMA" VARCHAR2(4000), 
...
CREATE TABLE "DOVELA_CONTROL"."SDW$ERR$_02_productBackLog" 
   (	"ORA_ERR_NUMBER$" NUMBER, 
	...
	"ESTIMACION_HRS" VARCHAR2(4000), 
	"HORAS_RESTANTES" VARCHAR2(4000), 
	"TAREAS_CANT" VARCHAR2(4000), 
	"TAREAS_TERMINADAS" VARCHAR2(4000), 
	"TAREAS_POR_TERMINAR" VARCHAR2(4000), 
	"RECURSO_ASIGNADO" VARCHAR2(4000), 
	"ESTADO" VARCHAR2(4000), 
...
COMMENT ON TABLE DOVELA_CONTROL."SDW$ERR$_02_productBackLog" IS 'DML Error Logging table for "DOVELA_CONTROL"."02_productBackLog"';

CREATE TABLE "DOVELA_CONTROL"."TAREAS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"TAREA" VARCHAR2(200 CHAR), 
	"TAREA_DESCRIPCION" VARCHAR2(4000 CHAR), 
	"CRITERIO_ACEPTACION" VARCHAR2(4000 CHAR), 
	"HORAS_ESTIMACION" NUMBER, 
	"HORAS_REALES" NUMBER, 
	"PRIORIDAD" VARCHAR2(100 CHAR), 
	"COMPLEJIDAD" VARCHAR2(100 CHAR), 
...
ALTER TABLE "DOVELA_CONTROL"."TAREAS" ADD CONSTRAINT "TAREAS_CON" FOREIGN KEY ("ID")
	  REFERENCES "DOVELA_CONTROL"."PRODUCT_BACK_LOG" ("ID") ENABLE;
;

CREATE TABLE "DOVELA_CONTROL"."TIPOS_SOLICITUD" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
CREATE TABLE "DOVELA_CONTROL"."TIPO_PRODUCTO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"TIPO" VARCHAR2(100 CHAR), 
...
CREATE OR REPLACE procedure DOVELA_CONTROL.eba_demo_chart_data
as
  l_open   number;
  l_close  number;
  l_high   number;
...
CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92907" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92910" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92913" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92916" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92919" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92922" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92925" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92928" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_92931" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;

CREATE SEQUENCE DOVELA_CONTROL."ISEQ$$_93051" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE CACHE 20 NOORDER ;